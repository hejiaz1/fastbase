...
class Service
{
     ...
     * @param boolean     $redirect  是否支持重定向，PC、WAP默认是跳转
     * @return string
     * @throws Exception
     */
    public static function submitOrder($amount, $orderid = null, $type = null, $title = null, $notifyurl = null, $returnurl = null, $method = null, $redirect = true)
    {
        if (!is_array($amount)) {
            $params = [
                'amount'    => $amount,
