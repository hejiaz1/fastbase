...
class Auth
{
    ...
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id', 'uuid', 'uuid_code','username', 'nickname', 'mobile', 'avatar', 'score','gender','birthday', 'wechat_code', 'bio', 'follow_num', 'fans_num', 'note_num', 'note_like_num', 'note_top_num','province','city','area','circle_showtype'];
    ...
    public function register($username, $password, $email = '', $mobile = '', $extend = [])
    {
        ...
        if ($username && User::getByNickname($username)) {
        ...
        $data = [
            'uuid'      => Random::session_id(),    // 会员标识
            'uuid_code' => \think\Config::get("site")['uuid_code_prefix'].'_'.Random::session_id(),   // 会员号
            'group_id' => 1,
            'username' => $username,
            'password' => $password,
            'email'    => $email,
