define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'test/index/index' + location.search,
                    add_url: 'test/index/add',
                    edit_url: 'test/index/edit',
                    del_url: 'test/index/del',
                    multi_url: 'test/index/multi',
                    import_url: 'test/index/import',
                    table: 'test',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'test/index/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
